    ...
    for y in range(5):
        for x in range(5):
            ...
            if board[x][y] == 1:
                ...
                img = pygame.image.load('./Assets/swap.png').convert_alpha()
...
while run:
        ...
        for event in pygame.event.get():
            ...
            if game_state == 0:
                ...
                main_menu(event) 
                name = BASE_FONT.render(name_input, 1, (255,0,0)) 
            else:
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_BACKSPACE:
        ...
        if game_state == 0: #หน้าพิมพ์ชื่อ
            ...
            try:
                ...
                game_state, new_players = recieved_data 
